package com.teamazing.validators;
...
public class FileUploadValidator implements Validator 
{
            ...
            Object value) throws ValidatorException 
    {
        ...
        // 2. validate file type (only text files allowed) <-- THIS IS KEY!!!
        ...
        // 3. validate file size (should not be greater than 10KB [old value 512 bytes])
        if (part.getSize() > 10240L) 
        {
